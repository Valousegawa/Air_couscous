...
public class HardCodedParameters {
	...
	public static final int defaultWidth = 800, defaultHeight = 600, heroesStartX = 20, heroesStartY = 500,
			heroesWidth = 21, heroesHeight = 31, heroesStep = 20, ennemyWidth = 21, ennemyHeight = 31, phantomStep = 10,
			bonusWidth = 10, bonusHeight = 20;
	...
	public static final int timerWidth = 80, timerHeight = 60;
	public static final int winWidth = 450, winHeight = 380, winPositionX = 60, winPositionY = 150;
	public static final int gameOverWidth = 430, gameOverHeight = 400, gameOverPositinX = 60, gameOverPositionY = 150;
